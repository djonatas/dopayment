...
class CommonValidator {
    constructor(body) {
        const { gateway, customerInfo, paymentInfo, products } = body;
    ...
    hasPaymentMethod() {
        this.validation.isRequired(this.paymentInfo.paymentData.type, 'BASE-Validator: The payment attribute "type" is required');
    }
